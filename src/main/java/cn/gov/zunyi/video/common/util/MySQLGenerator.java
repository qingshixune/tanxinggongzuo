...
public class MySQLGenerator {
	   ...
	   private static String packageName="party";    //文件路径
	    private static String authorName="Danny Lee";     //作者
	    private static String table="tb_test";                  //table名字
	    ...
	    public static void main(String[] args) throws IOException {
	        ...
	        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
	                ...
	                new DataSourceConfig()
	                        ...
	                        .setUsername("root")
	                        .setPassword("&y|agiUi@H)4gr")
	                        .setUrl("jdbc:mysql://139.217.202.240:3306/party?characterEncoding=utf8")
	        ).setStrategy(
                // 策略配置
                new StrategyConfig()
	                ...
	                new InjectionConfig() {
	                    ...
	                    public String outputFile(TableInfo tableInfo) {
	                        return path+"/src/main/java/cn/gov/zunyi/party/web/controller/" + tableInfo.getEntityName() + "Controller.java";
	                    }
