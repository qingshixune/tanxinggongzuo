...
public class UnicodeUtil {
	...
	public static void main(String arg[]) {
		String unicode = UnicodeUtil
				.toUnicode("关于我们     " + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(new Date()), true);
		System.out.println(unicode);

		System.out.println(UnicodeUtil.fromUnicode(unicode));
	}
