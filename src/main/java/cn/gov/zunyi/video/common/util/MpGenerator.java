...
public class MpGenerator {
	...
	public static void main(String[] args) {
		...
		dsc.setUsername("mashu");
		dsc.setPassword("w3*z(59P&R/s_J3");
		dsc.setUrl("jdbc:mysql://139.219.101.115:3306/mashu?characterEncoding=utf8");
