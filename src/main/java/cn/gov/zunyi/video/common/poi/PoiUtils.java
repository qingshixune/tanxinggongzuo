package cn.gov.zunyi.video.common.poi;

import cn.gov.zunyi.video.model.Employee;
    ...
    public static ResponseEntity<byte[]> exportEmp2Excel(List<Employee> emps) {
        ...
        try {
            ...
            for (int i = 0; i < emps.size(); i++) {
                ...
                row.createCell(7).setCellValue(emp.getName());
                row.createCell(8).setCellValue(emp.getNativePlace());
                row.createCell(9).setCellValue(emp.getName());
                ...
                row.createCell(13).setCellValue(emp.getName());
                row.createCell(14).setCellValue(emp.getName());
